...
const ProfilePic = ({ id, image, titleComponent }) => {
  return (
    <Link
      id={`${id}-pfp`}
      to={`#projects/${id}`}
    ...
    >
      <img
        src={image}
        alt="profile-pic-alt"
        className="transition-scale max-h-72 object-contain rounded-xl"
      />
...
const Title = ({ artistName, id, subtitle }) => {
  return (
...
export const Project = ({ id, works, description, titleComponent }) => {

...
const Music = () => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl">projects/music</h1>
      <div
        id="project-sam-denton"
        className="flex flex-col flex-wrap [&>*]:transition-all [&>*]:duration-100 mt-16 justify-center text-white backdrop-blur"
      >
        <button
          id={0}
          className="appearance-none text-3xl"
          title="Sam Denton"
        ...
        >
          <img
            src={samPfp}
            alt="sam-denton-alt"
            className="flex max-h-[300px] justify-center object-contain rounded-xl m-5 mx-auto"
          />
        </button>
        <label htmlFor={0}>Sam Denton</label>
        <p id="desc" className="text-2xl">
          singer/songwriter
        </p>
        <div
          id="music-page"
          className={`h-screen w-screen fixed top-0 origin-top bg-gray-700 backdrop-blur-md ${
            expanded == 0
              ? "scale-100 block blur-none"
              : "scale-0 h-min blur-md"
          }`}
        >
